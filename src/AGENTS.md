...
- `public/robots.txt` allows all crawlers and points at the apex sitemap. `public/llms.txt` is the agent overview (H1 + summary + key links). Do not put operational runbooks in either file.
